        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<form method="POST" action="addroom_model.php">
					...
					<div class="row">
						<div class="col-lg-4">
							<label class="control-label" style="position:relative; top:7px;">โปรเจ็คเตอร์:</label>
						</div>
						<div class="col-lg-8">
							<input type="number" class="form-control" name="projector">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						...
						<div class="col-lg-8">
							<input type="number" class="form-control" name="microphone">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
